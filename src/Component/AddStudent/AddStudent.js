    ...
    const schema = yup.object().shape({
        ...
        certificate: yup.string().required("Please select Yes or No for certificate"),
    });
                            ...
                            <Card.Body>
                                <Form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <Form.Group>
                                        ...
                                        <Form.Control.Feedback type="invalide">{errors.status?.message}</Form.Control.Feedback>
                                    </Form.Group>
